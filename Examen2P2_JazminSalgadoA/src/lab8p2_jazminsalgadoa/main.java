...
public class main extends javax.swing.JFrame implements Serializable {
    ...
    public main() {
        ...
        DefaultComboBoxModel cb = new DefaultComboBoxModel(aco.getListC().toArray());
    ...
    private void initComponents() {
        ...
        vender = new javax.swing.JProgressBar();
        ...
        l_eliminar1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                l_eliminar1MouseClicked(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(116, 116, 116)
                        .addComponent(vender, javax.swing.GroupLayout.PREFERRED_SIZE, 501, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(vender, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        pn_menuuserLayout.setVerticalGroup(
            ...
            .addGroup(pn_menuuserLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tab_user, javax.swing.GroupLayout.PREFERRED_SIZE, 463, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bt_registrarseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_registrarseMouseClicked
        ...
        aj.cargar();
        aj.setJugador(new jugador(user, mail, pais, d, pswrd, 100000));
        aj.escribir();
        ...
        try {
            for (int i = 0; i < aj.getListJ().size(); i++) {
                if (aj.getListJ().get(i).getCorreo().equalsIgnoreCase(user) && aj.getListJ()
                    ...
                    found = "Usuario encontrado, bienvenido!";
                    DefaultComboBoxModel cb = new DefaultComboBoxModel(aco.getListC().toArray());
                    cb_concesionariacompra.setModel(cb);
                    ...
                    ab.start();
                    pb_buscar.setValue(0);
                    found = "Usuario ingresado no existe";
                }
            }
        } catch (Exception e) {
        }
    ...
    private void bt_agregarcarroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_agregarcarroMouseClicked
        ...
        if (pos != -1) {
            ...
            ac.setCarro(c);
            ac.escribir();
            if (!aco.getListC().isEmpty() && pos < aco.getListC().size()) {
                aco.getListC().get(pos).getCarrosventa().add(c);
            } else {
            ...
            JOptionPane.showMessageDialog(this, "Seleccione un elementos");
        }
    ...
    private void bt_agregaconsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_agregaconsMouseClicked
        ...
        aco.cargar();
        aco.setConcesionaria(new concesionaria(cn, cl));
        DefaultComboBoxModel cb = new DefaultComboBoxModel(aco.getListC().toArray());
        cb_concesionariacompra.setModel(cb);
        aco.escribir();
    ...
    private void tab_adminStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_tab_adminStateChanged
        if (tab_admin.getSelectedIndex() == 1) {
            aco.cargar();
            DefaultComboBoxModel mc = new DefaultComboBoxModel(aco.getListC().toArray());
    ...
    private void bt_agregarcircuitoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_agregarcircuitoMouseClicked
        acir = new AdministrarCircuito("./circuitos.cct");
        ...
        acir.cargar();
        acir.setCircuito(new circuito(longi, cantv, type, loc));
        JOptionPane.showMessageDialog(this, "Circuito agregado exitosamente");
        acir.escribir();
        tf_loccir.setText("");
        tf_tipocarrera.setText("");
        tf_lc.setText("");
        tf_cantc.setText("");
    ...
    ;
    AdministrarCircuito acir;
    AdministrarConcesionaria aco = new AdministrarConcesionaria("./concesionarias.cns");
    ;
    ...
    private javax.swing.JProgressBar vender;
